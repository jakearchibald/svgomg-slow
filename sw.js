...
"use strict";function activate(){var e,t,n,s;return regeneratorRuntime.async(function(r){for(;;)switch(r.prev=r.next){case 0:return r.next=2,caches.keys();case 2:e=r.sent,t=e[Symbol.iterator]();case 4:if((n=t.next()).done){r.next=13;break}if(s=n.value,/^svgomgslow-/.test(s)){r.next=8;break}return r.abrupt("continue",11);case 8:if(-1!=expectedCaches.indexOf(s)){r.next=11;break}return r.next=11,caches["delete"](s);case 11:r.next=4;break;case 13:return r.next=15,storage.set("active-version",version);case 15:case"end":return r.stop()}},null,this)}function handleFontRequest(e){var t,n,s;return regeneratorRuntime.async(function(r){for(;;)switch(r.prev=r.next){case 0:return r.next=2,caches.match(e);case 2:if(t=r.sent,!t){r.next=5;break}return r.abrupt("return",t);case 5:return r.next=7,fetch(e.clone());case 7:return n=r.sent,r.next=10,caches.open("svgomgslow-fonts");case 10:return s=r.sent,s.put(e,n.clone()),r.abrupt("return",n);case 13:case"end":return r.stop()}},null,this)}require("regenerator/runtime"),require("./cache-polyfill");var storage=require("../utils/storage"),version=require("../../changelog.json")[0].version,cacheVerion=version.split(".")[0];self.addEventListener("install",function(e){var t=this;e.waitUntil(function(){var e,n,s;return regeneratorRuntime.async(function(t){for(;;)switch(t.prev=t.next){case 0:return e=storage.get("active-version"),t.next=3,caches.open("svgomgslow-static-"+cacheVerion);case 3:return n=t.sent,t.next=6,n.addAll(["./","imgs/icon.png","css/all.css","js/gzip-worker.js","js/page.js","js/prism-worker.js","js/svgo-worker.js","changelog.json",new Request("https://fonts.googleapis.com/css?family=Roboto:400,700|Inconsolata",{mode:"no-cors"})]);case 6:return t.next=8,e;case 8:if(s=t.sent,s&&s.split(".")[0]!==version.split(".")[0]){t.next=13;break}return self.skipWaiting&&self.skipWaiting(),t.next=13,activate();case 13:case"end":return t.stop()}},null,t)}())});var expectedCaches=["svgomgslow-static-"+cacheVerion];self.addEventListener("activate",function(e){e.waitUntil(activate())}),self.addEventListener("fetch",function(e){var t=new URL(e.request.url);e.respondWith("fonts.gstatic.com"==t.host?handleFontRequest(e.request):caches.open("svgomgslow-static-"+cacheVerion).then(function(t){return t.match(e.request)}).match(e.request).then(function(t){return t||fetch(e.request)}))});
//# sourceMappingURL=out.js.map

},{"../../changelog.json":3,"../utils/storage":6,"./cache-polyfill":4,"regenerator/runtime":2}],2:[function(require,module,exports){
(function (global){
!function(t){"use strict";function r(t,r,e,n){return new i(t,r,e||null,n||[])}function e(t,r,e){try{return{type:"normal",arg:t.call(r,e)}}catch(n){return{type:"throw",arg:n}}}function n(){}function o(){}function i(t,r,n,o){function i(r,o){if(u===w)throw new Error("Generator is already running");if(u===m)return f();for(;;){var i=c.delegate;if(i){var a=e(i.iterator[r],i.iterator,o);if("throw"===a.type){c.delegate=null,r="throw",o=a.arg;continue}r="next",o=s;var l=a.arg;if(!l.done)return u=g,l;c[i.resultName]=l.value,c.next=i.nextLoc,c.delegate=null}if("next"===r){if(u===v&&"undefined"!=typeof o)throw new TypeError("attempt to send "+JSON.stringify(o)+" to newborn generator");u===g?c.sent=o:delete c.sent}else if("throw"===r){if(u===v)throw u=m,o;c.dispatchException(o)&&(r="next",o=s)}else"return"===r&&c.abrupt("return",o);u=w;var a=e(t,n,c);if("normal"===a.type){u=c.done?m:g;var l={value:a.arg,done:c.done};if(a.arg!==x)return l;c.delegate&&"next"===r&&(o=s)}else"throw"===a.type&&(u=m,"next"===r?c.dispatchException(a.arg):o=a.arg)}}var a=r?Object.create(r.prototype):this,c=new l(o),u=v;return a.next=i.bind(a,"next"),a["throw"]=i.bind(a,"throw"),a["return"]=i.bind(a,"return"),a}function a(t){var r={tryLoc:t[0]};1 in t&&(r.catchLoc=t[1]),2 in t&&(r.finallyLoc=t[2],r.afterLoc=t[3]),this.tryEntries.push(r)}function c(t){var r=t.completion||{};r.type="normal",delete r.arg,t.completion=r}function l(t){this.tryEntries=[{tryLoc:"root"}],t.forEach(a,this),this.reset()}function u(t){if(t){var r=t[p];if(r)return r.call(t);if("function"==typeof t.next)return t;if(!isNaN(t.length)){var e=-1,n=function o(){for(;++e<t.length;)if(h.call(t,e))return o.value=t[e],o.done=!1,o;return o.value=s,o.done=!0,o};return n.next=n}}return{next:f}}function f(){return{value:s,done:!0}}var s,h=Object.prototype.hasOwnProperty,p="function"==typeof Symbol&&Symbol.iterator||"@@iterator",y="object"==typeof module,d=t.regeneratorRuntime;if(d)return void(y&&(module.exports=d));d=t.regeneratorRuntime=y?module.exports:{},d.wrap=r;var v="suspendedStart",g="suspendedYield",w="executing",m="completed",x={},L=o.prototype=i.prototype;n.prototype=L.constructor=o,o.constructor=n,n.displayName="GeneratorFunction",d.isGeneratorFunction=function(t){var r="function"==typeof t&&t.constructor;return r?r===n||"GeneratorFunction"===(r.displayName||r.name):!1},d.mark=function(t){return t.__proto__=o,t.prototype=Object.create(L),t},d.async=function(t,n,o,i){return new Promise(function(a,c){function l(t){var r=e(this,null,t);if("throw"===r.type)return void c(r.arg);var n=r.arg;n.done?a(n.value):Promise.resolve(n.value).then(f,s)}var u=r(t,n,o,i),f=l.bind(u.next),s=l.bind(u["throw"]);f()})},L[p]=function(){return this},L.toString=function(){return"[object Generator]"},d.keys=function(t){var r=[];for(var e in t)r.push(e);return r.reverse(),function n(){for(;r.length;){var e=r.pop();if(e in t)return n.value=e,n.done=!1,n}return n.done=!0,n}},d.values=u,l.prototype={constructor:l,reset:function(){this.prev=0,this.next=0,this.sent=s,this.done=!1,this.delegate=null,this.tryEntries.forEach(c);for(var t,r=0;h.call(this,t="t"+r)||20>r;++r)this[t]=null},stop:function(){this.done=!0;var t=this.tryEntries[0],r=t.completion;if("throw"===r.type)throw r.arg;return this.rval},dispatchException:function(t){function r(r,n){return i.type="throw",i.arg=t,e.next=r,!!n}if(this.done)throw t;for(var e=this,n=this.tryEntries.length-1;n>=0;--n){var o=this.tryEntries[n],i=o.completion;if("root"===o.tryLoc)return r("end");if(o.tryLoc<=this.prev){var a=h.call(o,"catchLoc"),c=h.call(o,"finallyLoc");if(a&&c){if(this.prev<o.catchLoc)return r(o.catchLoc,!0);if(this.prev<o.finallyLoc)return r(o.finallyLoc)}else if(a){if(this.prev<o.catchLoc)return r(o.catchLoc,!0)}else{if(!c)throw new Error("try statement without catch or finally");if(this.prev<o.finallyLoc)return r(o.finallyLoc)}}}},_findFinallyEntry:function(t){for(var r=this.tryEntries.length-1;r>=0;--r){var e=this.tryEntries[r];if(e.tryLoc<=this.prev&&h.call(e,"finallyLoc")&&(e.finallyLoc===t||this.prev<e.finallyLoc))return e}},abrupt:function(t,r){var e=this._findFinallyEntry(),n=e?e.completion:{};return n.type=t,n.arg=r,e?this.next=e.finallyLoc:this.complete(n),x},complete:function(t,r){if("throw"===t.type)throw t.arg;return"break"===t.type||"continue"===t.type?this.next=t.arg:"return"===t.type?(this.rval=t.arg,this.next="end"):"normal"===t.type&&r&&(this.next=r),x},finish:function(t){var r=this._findFinallyEntry(t);return this.complete(r.completion,r.afterLoc)},"catch":function(t){for(var r=this.tryEntries.length-1;r>=0;--r){var e=this.tryEntries[r];if(e.tryLoc===t){var n=e.completion;if("throw"===n.type){var o=n.arg;c(e)}return o}}throw new Error("illegal catch attempt")},delegateYield:function(t,r,e){return this.delegate={iterator:u(t),resultName:r,nextLoc:e},x}}}("object"==typeof global?global:"object"==typeof window?window:this);
